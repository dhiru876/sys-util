...
import { LaptopMinimalIcon, Loader2, MicIcon, MousePointer2Icon } from "lucide-react";
...
export const Screenshot = ({
  ...
  return (
    ...
    >
      {isAwaitingVoiceForScreenshot ? (
        <MicIcon className="h-4 w-4 animate-pulse text-green-500" />
      ) : isScreenshotLoading ? (
