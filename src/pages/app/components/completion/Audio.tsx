...
export const Audio = ({
  ...
  const { selectedSttProvider, sysutilApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(sysutilApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          sysutilApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
